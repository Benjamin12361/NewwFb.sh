...
echo $i" |"$cy"     CYBER HITAM TERSAKITI"$i"         |"
echo $i" |"$me"─────────────────────────────────────────────"$i"|"
echo $i" |"$pu" AUTHOR :"$ku" •MRX•BENJAMIN  [BENJAMIN]"$i"          |"
echo $i" |"$pu" FACEBOOK :"$ku" Privasi"$i"                   |"
echo $i" |"$pu" THANKS TO :"$cy"~ [ALLAH SWT]"$i"  |"
echo $i" |"$cy"            ~ [cyber] [%MR.S%] [Light Cyber Indonesia]"$i" |"
echo $i" |"$pu" Contack WhatsApp :"$ku" 089637888353"$i"             |"
echo $i" |"$pu" Contack Gmail :"$ku" privasi@gmail.com"$i"      |"
echo $i"["$bi"•"$i"]"$me"───────────────────────────────────────────"$i"["$bi"•"$i"]"
echo
echo $i"────────────────────────────────    ─────"
...
echo $i"────────────────────────────────    ─────"
echo
echo $me"┌==="$bi"["$i"BENJAMIN"$bi"]"$me"======"$bi"["$i""Pilih Nomornya""$bi"]"
echo $me"¦"
read -p"└──# " pil
...
sleep 2
echo $ku"WhatsApp :"$i" 089637888353"
echo $ku"Facebook :"$i"privasi"
sleep 2
